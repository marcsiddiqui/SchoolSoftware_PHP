            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="<?php echo "http://localhost:82/sms/Layouts/Admin/images/logo/logo_icon.png" ?>" alt="#" /></a>
                     </div>
                  </div>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="http://localhost:82/sms/feeTypes/FeeTypes.php"><i class="fa fa-money green_color"></i> <span>Fee Types</span></a></li>
                     <li>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="<?php echo "http://localhost:82/sms/Layouts/Admin/images/logo/logo.png" ?>" alt="#" /></a>
                        </div>
